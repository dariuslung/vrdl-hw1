...
def run_ensemble_inference(
    ...
    Batch size is reduced to 16 to accommodate loading two models.
    """
    ...
    print(
        f"Starting ensemble inference on {len(test_dataset)} "
    ...
    print(
        ...
        f"Predictions saved to '{output_csv_path}'."
    )
...
if __name__ == "__main__":
    ...
    model_a_checkpoint = "best_custom_resnet50_model.pth"
    model_b_checkpoint = "best_swa_resnet50_model.pth"
    ...
    if not os.path.exists(target_test_directory):
        ...
        run_ensemble_inference(
            ...
            model_a_path=model_a_checkpoint,
            model_b_path=model_b_checkpoint,
            output_csv_path=output_filename,
            num_classes=target_categories,
            batch_size=16  # Kept lower to prevent out-of-memory errors
        )